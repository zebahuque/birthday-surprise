let w = (c.width = window.innerWidth),
  h = (c.height = window.innerHeight * 0.8),
  ctx = c.getContext("2d"),
  hw = w / 2;
(hh = h / 2),
  (opts = {
    // change the text in here //
    strings: ["happy birthday, binh!"],
    charSize: 30,
    charSpacing: 35,
    lineHeight: 40,
...
function Letter(char, x, y) {
  ...
  this.colors = ["#ff4081", "#ffd54f", "#8bc34a", "#00bcd4", "#7e57c2"];
...
Letter.prototype.step = function () {
  if (this.phase === "firework") {
    ...
    ++this.tick;
    var colorIndex = Math.floor(this.tick / 10) % this.colors.length;
